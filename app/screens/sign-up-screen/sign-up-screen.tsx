...
export const SignUpScreen: React.FunctionComponent<SignInScreenProps> = observer(() => {
  ...
  const renderForm = () => (
    <View style={styles.container}>
      <Text category="h1">signUpScreen.title</Text>
      <SizedBox h={7} />
      ...
      <Animated.View style={[getOpacity(animFgpw), styles.linkView]}>
        <Text themeColor="color-basic-600" underline></Text>

        <TouchableOpacity
          style={styles.btnForgot}
          onPress={() => NavigateService.navigate("signUpScreen")}
        >
          <Text themeColor="color-basic-600">auth.signIn</Text>
        </TouchableOpacity>
      </Animated.View>
      <SizedBox h={4} />
  ...
  return (
    <Screen>
      <AuthHeader
        ...
        onLeftPress={() =>
          NavigateService.navigate("welcomeScreen", { transition: strings.transitionNone })
        }
      />
